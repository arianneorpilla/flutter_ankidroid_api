package com.example.flutter_ankidroid_api;
        ...
        if (modelExists("jidoujisho")) {
            ...
            modelId = api.addNewCustomModel("jidoujisho",
                    ...
                    new String[] {"{{Audio}}<br>{{Image}}<br><br><p id=\"sentence\">{{Sentence}}</p><br>" +
                            "<hr id=answer><p id=\"reading\">{{Reading}}</p><h2 id=\"word\">{{Word}}</h2><br><p><small id=\"meaning\">{{Meaning}}</small></p>"},
                    "p {\n" +
                            "    margin: 0px\n" +
                            "}\n" +
                            "\n" +
                        ...
                        (call, result) -> {
                            switch (call.method) {
                                case "addNote":
                                    ...
                                    addNote(deck, image, audio, sentence, answer, reading, meaning);
                                    break;
